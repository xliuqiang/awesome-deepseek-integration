...
<table>
    ...
    <tr>
        <td> <img src="https://www.translatebase.net/themes/image/logo/icon.png" alt="Icon" width="64" height="auto" /> </td>
        <td> <a href="https://www.translatebase.net"> TrabslateBase </a> </td>
        <td>Quickly translate web content, Video subtitles and pdf files in many languages to meet diverse needs.</td>
    </tr>
</table>
